...
const Navbar = () => {
  return (
    <div className="max-w-screen-xl mx-auto text-white py-4 border-b-[1px] border-zinc-600">
      <nav className="flex items-center justify-between">
        
        <div className="leftNav flex gap-[4vw]">
          <div className="logo  w-[13%] flex gap-2">
            <svg
              className="w-[10%]"
              // width="100%"
              // height="100%"
                ...
                <a key={index} className="flex items-center gap-2">
                  {index === 1 && (
                    <span
                      ...
                      className="inline-block bg-green-500 w-2 h-2 rounded-full"
                    ></span>
                  )}
                  {item}
                </a>
